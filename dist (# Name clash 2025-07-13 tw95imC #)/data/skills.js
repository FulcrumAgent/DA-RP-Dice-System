...
exports.SKILL_VALUES = exports.SKILLS = void 0;
exports.getInitialSkillsState = getInitialSkillsState;
exports.SKILLS = [
    {
        id: 'battle',
        name: 'Battle',
...
exports.SKILL_VALUES = [9, 7, 6, 5, 4];
function getInitialSkillsState() {
    return {
        remainingSkills: exports.SKILLS.map(skill => skill.name),
        remainingValues: [...exports.SKILL_VALUES],
        assignedSkills: {},
