...
async function handleFinalizeButton(interaction) {
    ...
    try {
        ...
        const character = await character_manager_1.characterManager.createCharacter(member.id, interaction.guild.id, state.data.name || 'Unnamed Character', state.data.concepts || [], {
