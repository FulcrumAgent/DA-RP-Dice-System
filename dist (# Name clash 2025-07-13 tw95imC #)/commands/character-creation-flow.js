...
const STEP_TITLES = {
    [character_1.CREATION_STEPS.NAME]: 'Character Name',
    [character_1.CREATION_STEPS.CONCEPT]: 'Character Concept',
    [character_1.CREATION_STEPS.ARCHETYPE]: 'Archetype',
    [character_1.CREATION_STEPS.SKILLS]: 'Skills',
    [character_1.CREATION_STEPS.FOCUSES]: 'Focuses',
    [character_1.CREATION_STEPS.DRIVES]: 'Drives',
    [character_1.CREATION_STEPS.DRIVE_STATEMENTS]: 'Drive Statements',
    [character_1.CREATION_STEPS.TALENTS]: 'Talents',
    [character_1.CREATION_STEPS.ASSETS]: 'Assets',
    [character_1.CREATION_STEPS.TRAITS]: 'Traits',
    [character_1.CREATION_STEPS.STARTING_POOLS]: 'Starting Resource Pools',
    [character_1.CREATION_STEPS.SUMMARY]: 'Summary',
    [character_1.CREATION_STEPS.FINALIZE]: 'Finalize'
};
