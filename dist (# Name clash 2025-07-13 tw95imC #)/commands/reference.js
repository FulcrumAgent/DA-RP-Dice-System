...
exports.SKILL_FOCUSES = exports.data = void 0;
...
exports.SKILL_FOCUSES = {
    'Battle': ['Blades', 'Projectiles', 'Unarmed', 'Tactics', 'Duelist Training', 'Swordmastery', 'Shield Combat', 'Fremen Martial Arts', 'Improvised Weapons'],
    'Command': ['Military', 'Inspiration', 'Strategy', 'Politics', 'House Leadership', 'Smuggling Operations', 'Religious Authority', 'Morale Management', 'Negotiation (for Commanding)'],
    'Discipline': ['Fear', 'Pain', 'Temptation', 'Concentration', 'Meditation', 'Duty', 'Endurance', 'Deprivation', 'Obedience Conditioning', 'Training Against Interrogation'],
    'Drive': ['Groundcars', 'Ornithopters', 'Animals', 'Racing', 'Water Discipline', 'Sandrider', 'Navigation by Instinct'],
    'Infiltrate': ['Urban', 'Wilderness', 'Security', 'Disguise', 'Espionage', 'Sabotage', 'Forgery', 'Sietch Infiltration', 'Surveillance', 'Black Market Networks'],
    'Investigate': ['Research', 'Deduction', 'Forensics', 'Interrogation', 'Observation', 'Pattern Analysis', 'Information Gathering', 'Crime Scene', 'Mentat Calculations'],
    'Lore': ['History', 'Religion', 'Culture', 'Science', 'Fremen Lore', 'Bene Gesserit Lore', 'Guild Lore', 'House Histories', 'Planetology'],
    'Medicine': ['Surgery', 'Diagnosis', 'Pharmacology', 'Biology', 'Poison Lore', 'Herbalism', 'First Aid', 'Spice Medicine', 'Trauma Care'],
    'Mentat': ['Computation', 'Logic', 'Analysis', 'Strategy', 'Data Retrieval', 'Memory Palace', 'Pattern Recognition', 'Hypothetical Scenarios'],
    'Persuade': ['Negotiation', 'Deception', 'Seduction', 'Diplomacy', 'Intimidation', 'Manipulation', 'Oratory', 'Voice (Bene Gesserit)', 'Bribery', 'Rallying'],
    'Pilot': ['Ornithopters', 'Spacecraft', 'Combat', 'Navigation', 'Sandcraft', 'Shuttle Operations', 'Drop Landers', 'Heighliner Protocol'],
    'Spice': ['Harvesting', 'Prescience', 'Trade', 'Addiction (Spice Addiction)', 'Smuggling', 'Spice Engineering', 'Spice Testing', 'Fremen Spice Ritual', 'Market Analysis'],
    'Stealth': ['Urban', 'Wilderness', 'Crowds', 'Shadows', 'Desert Stealth', 'Camouflage', 'Silent Movement', 'Concealment', 'Escape'],
    'Survival': ['Desert', 'Arctic', 'Urban', 'Animals', 'Foraging', 'Water Procurement', 'Sandstorm Tactics', 'Sietch Survival', 'Extreme Heat'],
    'Tech': ['Repair', 'Engineering', 'Computers', 'Weapons', 'Ornithopter Maintenance', 'Shield Technology', 'Sietch Engineering', 'Environmental Systems', 'Salvage'],
    'Understand': ['Emotions', 'Deception', 'Motivation', 'Empathy', 'Truthsense', 'Social Cues', 'Political Undercurrents', 'Ritual Interpretation', 'Body Language']
};
function getSkillInformation(skillName) {
    const skillData = {
        'Battle': {
            ...
            focuses: exports.SKILL_FOCUSES['Battle'].join(', ')
        },
        'Command': {
            ...
            focuses: exports.SKILL_FOCUSES['Command'].join(', ')
        },
        'Discipline': {
            ...
            focuses: exports.SKILL_FOCUSES['Discipline'].join(', ')
        },
        'Drive': {
            ...
            focuses: exports.SKILL_FOCUSES['Drive'].join(', ')
        },
        'Infiltrate': {
            ...
            focuses: exports.SKILL_FOCUSES['Infiltrate'].join(', ')
        },
        'Investigate': {
            ...
            focuses: exports.SKILL_FOCUSES['Investigate'].join(', ')
        },
        'Lore': {
            ...
            focuses: exports.SKILL_FOCUSES['Lore'].join(', ')
        },
        'Medicine': {
            ...
            focuses: exports.SKILL_FOCUSES['Medicine'].join(', ')
        },
        'Mentat': {
            ...
            focuses: exports.SKILL_FOCUSES['Mentat'].join(', ')
        },
        'Persuade': {
        ...
        'Survival': {
            ...
            focuses: exports.SKILL_FOCUSES['Survival'].join(', ')
        },
        'Tech': {
            ...
            focuses: exports.SKILL_FOCUSES['Tech'].join(', ')
        },
        'Understand': {
            ...
            focuses: exports.SKILL_FOCUSES['Understand'].join(', ')
        }
    };
