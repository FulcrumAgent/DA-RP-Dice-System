/**
 * Mixed Archetypes System Data
 * Defines all archetypes, talents, assets, and focuses for the mixed archetype character creation
 */
...
export interface MixedCharacterState {
  userId: string;
  guildId: string;
  step: number;
  ...
  drives?: { [drive: string]: number };
  focuses?: { [skill: string]: string[] };
...
// Import constants from character-manager to ensure consistency
import { CharacterManager } from '../utils/character-manager';

export const DUNE_SKILLS = CharacterManager.DUNE_SKILLS;
export const DUNE_DRIVES = CharacterManager.DUNE_DRIVES;
export const SKILL_POINT_VALUES = CharacterManager.SKILL_POINT_VALUES;
export const DRIVE_POINT_VALUES = CharacterManager.DRIVE_POINT_VALUES;

export const ARCHETYPES: { [key: string]: ArchetypeData } = {
  'Agent': {
    name: 'Agent',
