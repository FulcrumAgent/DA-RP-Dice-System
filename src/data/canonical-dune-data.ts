/**
 * Canonical Dune: Adventures in the Imperium Data
 * Official rules and lists - DO NOT MODIFY without rulebook reference
 */

// Archetypes (Pick 1-3, to mix & match like Dune: Awakening)
...
// Drives (Point-Buy; Each with Description)
export const DRIVES = [
  { 
    name: 'Duty', 
...
// Skills (Point-Buy; Each with Description)
export const SKILLS = [
  { 
    name: 'Battle', 
...
// Focuses (Fixed List – Grouped by Skill) - OFFICIAL CANON ONLY
export const SKILL_FOCUSES: { [skill: string]: string[] } = {
  'Battle': [
    'Blades',
    'Projectiles',
    'Unarmed',
...
// General Talents (Available to all) - OFFICIAL CANON ONLY
...
// Archetype-Specific Talents - OFFICIAL CANON ONLY (4 talents per archetype)
export const ARCHETYPE_TALENTS: { [archetype: string]: Array<{ name: string; description: string }> } = {
  'Bene Gesserit': [
...
// General Assets (Available to all) - OFFICIAL CANON ONLY
...
// Archetype-Specific Assets - OFFICIAL CANON ONLY
export const ARCHETYPE_ASSETS: { [archetype: string]: Array<{ name: string; description: string }> } = {
  'Fremen': [
...
export const POINT_BUY_RULES = {
  ...
  FOCUSES_PER_SKILL: 1, // Each skill can have 1 focus at character creation
  TALENT_COUNT: 3,
  ASSET_COUNT: 3,
  MIN_ARCHETYPES: 1,
  MAX_ARCHETYPES: 3
