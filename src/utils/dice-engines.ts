...
export class DiceEngine {
   ...
   */
  static standardRoll(count: number, sides: number, modifier: number = 0): DiceResult {
   ...
   */
  static explodingRoll(count: number, sides: number, modifier: number = 0): DiceResult {
    const rolls: number[] = [];
   ...
   */
  static worldOfDarknessRoll(count: number, difficulty: number = 6, specialty: boolean = false): DiceResult {
   ...
   */
  static dune2d20Roll(target: number, bonusDice: number = 0): DiceResult {
...
export class DiceParser {
   ...
   */
  static parseStandardNotation(notation: string): { count: number; sides: number; modifier: number } {
   ...
   */
  static validateDiceParameters(count: number, sides: number): void {
